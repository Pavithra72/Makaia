...
public class RESTAssuredBase_Weather extends PreAndTest_Weather{
	...
	public static Map<String,String> setQueryParams(String city) {
		Map<String, String> parametersMap = new HashMap<String, String>();
		parametersMap.put("q",city);
		parametersMap.put("appid", "ea73207eef272669200945f5ae1e39da");
		return parametersMap;
	}
	public static Response getWithParams(String city) {
		return setLogs()
				.when()
				.queryParams(setQueryParams(city))
				.get();
	}
